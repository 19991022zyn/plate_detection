...
if __name__ == "__main__":
    ...
    # model_path      = '/home/ys/zyn/car_plate/yolov4-pytorch-master/yolov4-pytorch-master/logs/plate_ep041-loss1.828-val_loss1.782.pth'
    #------------------------------------------------------#
    #   输入的shape大小，一定要�?2的倍数
    #------------------------------------------------------#
    input_shape     = [416, 416]
    ...
    train_annotation_path = '/home/ys/zyn/car_plate/yolov4-pytorch-master/yolov4-pytorch-master/2007_train.txt'
    val_annotation_path = '/home/ys/zyn/car_plate/yolov4-pytorch-master/yolov4-pytorch-master/2007_val.txt'
    #----------------------------------------------------#
    #   获取classes和anchor
    #----------------------------------------------------#
    ...
    loss_history = LossHistory("logs/","plate")
    ...
    if True:
        ...
        for epoch in range(start_epoch, end_epoch):
            fit_one_epoch(model_train, model, yolo_loss, loss_history, optimizer, epoch, 
                    epoch_step, epoch_step_val, gen, gen_val, end_epoch, Cuda,"plate")
            lr_scheduler.step()
